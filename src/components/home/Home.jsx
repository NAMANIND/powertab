...
function Home() {
  ...
  const ximg = useTransform(
    scrollYProgress,
    [0, 0.27, 0.3, 0.45, 1],
    ["30vw", "30vw", "40vw", "40vw", "40vw"]
  );

  const opacityimg = useTransform(scrollYProgress, [0, 0.27, 0.3], [0, 0.2, 1]);
  ...
  return (
    <div
      className="flex flex-col items-center h-[600vh]  pb-20 font-bold max-md:px-5"
      style={{
        background:
      ...
      >
        <div className="flex flex-col  gap-5 justify-center items-center">
          ...
          >
            ...
            <div className=" text-2xl tracking-tighter font-normal  text-slate-900 max-md:mt-10 max-md:max-w-full max-md:text-4xl">
              Save, Share & Manage
            </div>
